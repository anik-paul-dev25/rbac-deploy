...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .post-image {
            width: 250px; /* Smaller fixed width for medium screens */
            height: 150px; /* Smaller fixed height for medium screens */
        }
    }
    @media (max-width: 576px) {
        ...
        .post-image {
            width: 200px; /* Smaller fixed width for small screens */
            height: 100px; /* Smaller fixed height for small screens */
        }
    }
</style>
<script>
